...
class FizzBuzzTextCreatorTest {
    ...
    void shouldBeFizz() {
        ...
        int number = 9;
        //when
        String expectFizz = new FizzBuzzTextCreator().addFizz(number);
        //then
    ...
    void shouldBeConvertedText() {
        ...
        int range = 100;
        //when
        String expectConvertedText = new FizzBuzzTextCreator().createFizzBuzzText(range);
        //then
