...
class FizzBuzzPlayerTest {
    ...
    void shouldBeFizz() {
        ...
        int number = 9;
        //when
        String expectFizz = new FizzBuzzPlayer().addFizz(number);
        //then
    ...
    void shouldBeBuzz() {
        ...
        int number = 25;
        //when
        String expectBuzz = new FizzBuzzPlayer().addBuzz(number);
        //then
    ...
    void shouldBeCreatedText() {
        ...
        int range = 100;
        //when
        String expectCreatedText = new FizzBuzzPlayer().createFizzBuzzText(range);
        //then
